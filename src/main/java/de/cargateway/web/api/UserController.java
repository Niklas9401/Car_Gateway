...
public class UserController {
    ...
    @PostMapping(path = "/role/addtouser", consumes = "application/x-www-form-urlencoded")
    ...
    public void refreshToken(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        if (authHeader != null && authHeader.startsWith("Bearer ")) {
            try {
                ...
                Algorithm algorithm = Algorithm.HMAC256("9n$V@h2aJeiyNfp*NVurJ8o8v%b&W4R3NWzJ85ZWQZ9p%!i2%B&L3R&sYaxiVU9b".getBytes());
